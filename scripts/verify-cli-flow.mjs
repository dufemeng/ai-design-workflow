...
writeFileSync(spec, JSON.stringify({
  ...
  states: [
    { id: 's-empty', screenId: 'home', kind: 'empty', driver: { type: 'query-param', params: { state: 'empty' } }, expected: { urlIncludes: 'state=empty' } },
    { id: 's-loading', screenId: 'home', kind: 'loading', driver: { type: 'query-param', params: { state: 'loading' } }, expected: { urlIncludes: 'state=loading' } },
    { id: 's-error', screenId: 'home', kind: 'error', driver: { type: 'query-param', params: { state: 'error' } }, expected: { urlIncludes: 'state=error' } },
    { id: 's-success', screenId: 'home', kind: 'success', driver: { type: 'query-param', params: { state: 'success' } }, expected: { urlIncludes: 'state=success' } },
  ],
